...
export const Route = createFileRoute("/$locale/cookies")({
  ...
  head: ({ params }) => {
    ...
    return {
      ...
      links: [
        { rel: "canonical", href: `/${locale}/cookies` },
        { rel: "alternate", hrefLang: "en", href: "/en/cookies" },
        { rel: "alternate", hrefLang: "fr", href: "/fr/cookies" },
        { rel: "alternate", hrefLang: "ar", href: "/ar/cookies" },
      ],
      scripts: [
